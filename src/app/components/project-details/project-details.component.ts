...
export class ProjectDetailsComponent implements OnInit {
  ...
  projects = [
    ...
    },
    {
      id: 'kotak',
      title: 'Portal 1',
      description: 'A secure, scalable portal built with Angular and RxJS, delivering high-performance, responsive, and secure user experiences.',
    ...
    },
    {
      id: 'nsdl',
      title: 'Portal 2',
      description: 'Modernized and optimized the Portal 2’s frontend to deliver a secure, high-performance, and accessible web experience.',
    ...
    },
    {
      ...
      description: 'A cross-platform React Native mobile application delivering secure, high-performance, and feature-rich user experiences.',
    ...
    },
    {
      id: 'android',
      title: 'Android App',
      description: 'A modern Android application built with Kotlin and Jetpack Compose, delivering secure, efficient, and modular user experiences.',
